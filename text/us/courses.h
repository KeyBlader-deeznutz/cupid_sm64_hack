COURSE_ACTS(COURSE_BOB, _("     UNDERWORLD DEPTHS"),
       _("THE START OF THE CLIMB")     , _("FOOTRACE WITH KOOPA THE QUICK") , _("SHOOT TO THE ISLAND IN THE SKY"),
...
COURSE_ACTS(COURSE_CCM, _("      BARREN SUBMIT"),
       _("BETWEEN A ROCK AND AN ICE WALL")             , _("LI'L PENGUIN LOST")             , _("BIG PENGUIN RACE"),
...
COURSE_ACTS(COURSE_THI, _("        WOODEN PARADISE"),
       _("HOW IS THERE A FORSEST WITH ALL THIS LAVA")      , _("THE TIP TOP OF THE HUGE ISLAND"), _("REMATCH WITH KOOPA THE QUICK"),
...
SECRET_STAR(COURSE_BITDW, _("   THE FORGE"))
