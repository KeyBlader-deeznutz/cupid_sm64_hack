...
const LevelScript level_thi_entry[] = {
	...
	AREA(1, thi_area_1),
		...
		OBJECT(MODEL_NONE, -1873, 3593, -1862, 0, -90, 0, 0x30C20000, bhvWarp),
		OBJECT(MODEL_NONE, -1564, 3593, -1862, 0, -90, 0, 0x30C20000, bhvWarp),
		...
		OBJECT(MODEL_BLACK_BOBOMB, -6571, 1558, 10284, 0, 0, 0, 0x00130000, bhvBobombBuddy),
