...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		OBJECT(MODEL_NONE, -1208, 7614, -363, 0, 0, 0, 0x00A10000, bhvWarp),
		OBJECT(MODEL_NONE, 2399, -6733, -2476, 0, 0, 0, 0x50A30000, bhvWarp),
		OBJECT(MODEL_NONE, 21, -4886, 2217, 0, 0, 0, 0x00000000, bhvGoombaTripletSpawner),
		OBJECT(MODEL_GOOMBA, -560, -4205, -1445, 0, 0, 0, 0x00000000, bhvGoombaTripletSpawner),
		OBJECT(MODEL_GOOMBA, -1909, -1828, -3091, 0, 0, 0, 0x00000000, bhvGoombaTripletSpawner),
		OBJECT(MODEL_GOOMBA, 766, -815, 731, 0, 0, 0, 0x00000000, bhvGoombaTripletSpawner),
		OBJECT(MODEL_GOOMBA, 1119, 1305, 1501, 0, 0, 0, 0x00000000, bhvGoombaTripletSpawner),
		...
		OBJECT(MODEL_KOOPA_WITHOUT_SHELL, -289, -1274, -974, 0, 0, 0, 0x00000000, bhvKoopa),
		...
		OBJECT(MODEL_Move, -1701, -6385, -1955, 0, 0, 0, 0x00000000, bhvMove),
		OBJECT(MODEL_Move, -1549, -6076, -1936, 0, 0, 0, 0x00000000, bhvMove),
		OBJECT(MODEL_GOOMBA, 68, -6153, -1953, 0, 0, 0, 0x00000000, bhvMove),
