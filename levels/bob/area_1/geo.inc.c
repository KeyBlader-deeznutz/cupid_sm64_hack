...
const GeoLayout bob_area_1_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 799, -4801, 1401, 0, 8, 0, bob_dl_Circle_004_mesh_layer_1),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -2261, -3721, 617, 0, 8, 0, bob_dl_Circle_005_mesh_layer_1),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 1902, -4642, 545, 0, 8, 0, bob_dl_Circle_006_mesh_layer_1),
		...
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 2822, -105, -1670, -180, -25, 27, bob_dl_Cube_021_mesh_layer_1),
		...
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 642, 4049, 2533, 0, -72, -153, bob_dl_Cube_025_mesh_layer_1),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 1859, 4542, 3041, 0, 49, -153, bob_dl_Cube_026_mesh_layer_1),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 2222, 6808, 505, 0, 101, -153, bob_dl_Cube_027_mesh_layer_1),
