...
const LevelScript level_ccm_entry[] = {
	...
	AREA(1, ccm_area_1),
		...
		OBJECT(MODEL_NONE, -1280, 6807, -309, 0, 0, 0, 0x30B20000, bhvWarp),
		OBJECT(MODEL_GOOMBA, 2589, -1605, -1699, 0, 0, 0, 0x00000000, bhvFloomba),
		...
		OBJECT(MODEL_GOOMBA, -2344, 1134, -156, 0, 0, 0, 0x00000000, bhvFloomba),
