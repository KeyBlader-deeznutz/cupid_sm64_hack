...
void scroll_bitdw_dl_Cylinder_003_mesh_layer_1_vtx_0() {
	int i = 0;
	int count = 46;
	int width = 64 * 0x20;
	int height = 64 * 0x20;
	...
	static int currentY = 0;
	int deltaY;
	Vtx *vertices = segmented_to_virtual(bitdw_dl_Cylinder_003_mesh_layer_1_vtx_0);
...
void scroll_bitdw_dl_Cylinder_004_mesh_layer_1_vtx_0() {
	int i = 0;
	int count = 46;
	int width = 64 * 0x20;
	int height = 64 * 0x20;
	...
	static int currentY = 0;
	int deltaY;
	Vtx *vertices = segmented_to_virtual(bitdw_dl_Cylinder_004_mesh_layer_1_vtx_0);
...
void scroll_bitdw_dl_Cylinder_005_mesh_layer_1_vtx_0() {
	int i = 0;
	int count = 46;
	int width = 64 * 0x20;
	int height = 64 * 0x20;
	...
	static int currentY = 0;
	int deltaY;
	Vtx *vertices = segmented_to_virtual(bitdw_dl_Cylinder_005_mesh_layer_1_vtx_0);
...
void scroll_bitdw_dl_Cylinder_006_mesh_layer_1_vtx_0() {
	int i = 0;
	int count = 46;
	int width = 64 * 0x20;
	int height = 64 * 0x20;
	...
	static int currentY = 0;
	int deltaY;
	Vtx *vertices = segmented_to_virtual(bitdw_dl_Cylinder_006_mesh_layer_1_vtx_0);
...
void scroll_bitdw() {
	...
	scroll_bitdw_dl_Cylinder_003_mesh_layer_1_vtx_0();
	scroll_bitdw_dl_Cylinder_004_mesh_layer_1_vtx_0();
	scroll_bitdw_dl_Cylinder_005_mesh_layer_1_vtx_0();
	scroll_bitdw_dl_Cylinder_006_mesh_layer_1_vtx_0();
