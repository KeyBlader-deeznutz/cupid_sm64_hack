...
const LevelScript level_bitdw_entry[] = {
	...
	AREA(1, bitdw_area_1),
		...
		OBJECT(MODEL_BLACK_BOBOMB, -2610, -3264, 4099, 0, -180, 0, 0x00000000, bhvFireSpitter),
		OBJECT(MODEL_BLACK_BOBOMB, -2131, -3264, 1698, 0, -180, 0, 0x00000000, bhvFireSpitter),
		...
		OBJECT(MODEL_NONE, -16930, -2764, -23451, 0, 0, 0, 0x601A0000, bhvWarp),
		OBJECT(MODEL_NONE, 1085, -8037, -14409, 0, 0, 0, 0x00C10000, bhvSpinAirborneWarp),
		MARIO_POS(0x01, 0, 1085, -8071, -14409),
		OBJECT(MODEL_NONE, -16930, -900, -23451, 0, 0, 0, 0x601A0000, bhvWarp),
		OBJECT(MODEL_NONE, -16930, -1939, -23451, 0, 0, 0, 0x601A0000, bhvWarp),
