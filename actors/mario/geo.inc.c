		...
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				...
				GEO_OPEN_NODE(),
					...
					GEO_OPEN_NODE(),
						GEO_DISPLAY_LIST(LAYER_TRANSPARENT, mario_000_offset_001_mesh_layer_4),
						GEO_DISPLAY_LIST(LAYER_TRANSPARENT, mario_000_offset_001_mesh_layer_5),
		...
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				...
				GEO_OPEN_NODE(),
					...
					GEO_OPEN_NODE(),
						GEO_DISPLAY_LIST(LAYER_ALPHA, mario_000_offset_001_mesh_layer_4_mat_override_metal_v3_0),
						GEO_DISPLAY_LIST(LAYER_TRANSPARENT, mario_000_offset_001_mesh_layer_5_mat_override_metal_v3_0),
						GEO_ANIMATED_PART(LAYER_OPAQUE, 87, 0, 0, NULL),
						GEO_OPEN_NODE(),
							GEO_ASM(0, geo_mario_head_rotation),
							GEO_ROTATION_NODE(LAYER_FORCE, 0, 0, 0),
		...
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				...
				GEO_OPEN_NODE(),
					...
					GEO_OPEN_NODE(),
						GEO_DISPLAY_LIST(LAYER_TRANSPARENT, mario_000_offset_001_mesh_layer_4_mat_override_metal_v3_0),
						GEO_DISPLAY_LIST(LAYER_TRANSPARENT, mario_000_offset_001_mesh_layer_5_mat_override_metal_v3_0),
						GEO_ANIMATED_PART(LAYER_OPAQUE, 87, 0, 0, NULL),
						GEO_OPEN_NODE(),
							GEO_ASM(0, geo_mario_head_rotation),
